...
describe("POST /todo", () => {
    ...
    it("should not add a task if the task's description is empty", async () => {
...
describe("DELETE /todo/:id", () => {
    ...
    it("should not delete a task if there's no task with the provided id", async () => {
        tarefas.push({ id: 10, descricao: "tarefa teste" });

        const response = await request.delete("/todo/11");
